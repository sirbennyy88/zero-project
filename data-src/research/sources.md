...
SOURCES_REGISTRY = [
  ...
  {"id":"atlas-data","name":"MITRE ATLAS","org":"MITRE","url":"https://github.com/mitre-atlas/atlas-data","endpoint":"https://raw.githubusercontent.com/mitre-atlas/atlas-data/main/dist/ATLAS-latest.yaml","auth":"none","format":"yaml","cadence":"monthly","licence":"MITRE public release","exploited_flag":false,"coverage_start":"n/a","verdict":"MANUAL-ONLY","page_use":"quarterly human skim for CVE-bearing AI incidents into manual.json"},
